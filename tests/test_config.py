...
""")
    ...
    assert cfg.get("cli", "benchmark_version") == str(usg_config.DEFAULT_CONFIG["cli"]["benchmark_version"])
...
def test_get_artifact_path(monkeypatch):
    ...
    assert oval_results_path == Path("/test_state_dir/ssg-TEST_PRODUCT-oval.xml.results-TEST_TS.xml")
